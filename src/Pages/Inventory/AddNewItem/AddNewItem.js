            ...
            <div className='min-h-[70vh] px-6 md:px-12 lg:px-24 py-16'>
                <div className=''>
                    ...
                    <form onSubmit={handleAddItem}>
                        ...
                        <div className="relative z-0 mb-6 w-full group">
                            <textarea rows={3} name="description" className="block py-2.5 px-0 w-full bg-transparent border-0 border-b-2 border-slate-400 appearance-none focus:outline-none focus:ring-0 focus:border-purple-700 peer" placeholder=" " required />
